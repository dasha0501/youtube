...
<body>
	<?php 
		...
		$txt = 'SELECT * FROM videos
		INNER JOIN users
		ON users.id = videos.usersID WHERE users.id="'.$_GET["id"].'"';
		$query = mysqli_query($con, $txt);
	?>;
	<!-- header -->
			...
			?>
					<div class="col-3"> <!--ВИДЕО -->
						<div class="embed-responsive embed-responsive-16by9 mb-3">
							<iframe src="" style="<?php echo $stroka["source"]?>"></iframe>
						</div>
						
						<div class="row">
							<div class="col-3 text-center">
								<img src="" style="background-image: url(<?php echo $stroka["img"]?>); background-size: 100% 100%;" class="w-75 rounded-circle">
							</div>
							<div class="col-9">							
